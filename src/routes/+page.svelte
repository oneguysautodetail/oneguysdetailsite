...
<main>
    ...
    <div class="intro-container">
        <div class="gradient-fade-up"></div>
            <div class="logo-container" id="logo-container" style:margin-top={`${(scroll/1.5)}px`} style:opacity={`${1 - (scroll/175)}`}>
    ...
    <div class="pricing-blade">
        <div class="pricing-gallery-container">
        {#each PRICING_DATA as service}
    ...
    <div class="footer-container" use:scrollRef={"footer"}>
        <div class="gradient-fade-down"></div>
        <div 
            class="content-box"
            data-sal="slide-up"
            data-sal-delay="200"
        ...
        >
            ...
            target="_blank"
            >
            <h4>13430 NE 136th Pl. Kirkland, WA 98034</h4>
            </a>
            <h3>Phone:</h3>
...
<script>
    ...
    import PriceCard from "../components/card.svelte";
...
<style lang="scss">
.site-bg {
    background: url("/images/oneguyintropic.jpeg");
...
.intro-container {
  ...
  .gradient-fade-up {
    ...
    width: 100%;
    height: 100%;
    background-image: linear-gradient(to top, rgba(0,0,0,1), rgba(248, 20, 20, 0));
  }
  .logo-container {
    display: flex;
...
.footer-container {
  ...
  .gradient-fade-down {
    ...
    width: 100%;
    height: 100%;
    background-image: linear-gradient(to bottom, rgba(0,0,0,1), rgba(248, 20, 20, 0));
  }
}
</style>