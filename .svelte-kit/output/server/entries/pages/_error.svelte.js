import { b as getContext, c as create_ssr_component, d as subscribe, e as escape } from "../../chunks/index.js";
const getStores = () => {
...
const Error$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="${"container"}"><div class="${"row"}"><div class="${"col-12"}"><div class="${"card"}"><h2>\u{1FAE4} Uh Oh</h2>
